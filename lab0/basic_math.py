...
def quadratic_equation(x, coeffs):
...
def functions(a_1, a_2):
    ...
    print(f"Функция 1: x_ext = {f_extr_result.x}. F(x_extr) = {f_extr_result.fun}")
    print(f"Функция 2: x_ext = {p_extr_result.x}. F(x_extr) = {p_extr_result.fun}")
